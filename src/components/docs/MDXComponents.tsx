...
export function CodeBlock({
  ...
  return (
    <pre
      className={`bg-black/70 border border-gray-800 rounded-lg p-4 md:p-6 overflow-x-auto my-6 ${
        className || ""
      }`}
    >
...
export function Callout({
  ...
  return (
    <div
      className={`border-l-4 rounded-r-lg p-4 md:p-5 my-6 flex gap-3 ${style}`}
    >
