  ...
  return (
    <MDXProvider components={mdxComponents}>
      <Routes>
        ...
        <Route path="/docs" element={<DocsLayout><DocsIndex /></DocsLayout>} />
        <Route path="/docs/installation" element={<DocsLayout><Installation /></DocsLayout>} />
        <Route path="/docs/project-structure" element={<DocsLayout><ProjectStructure /></DocsLayout>} />
        ...
        <Route path="/docs/env-variables" element={<DocsLayout><EnvVariables /></DocsLayout>} />
        <Route path="/docs/building" element={<DocsLayout><Building /></DocsLayout>} />
        <Route path="/docs/deployment" element={<DocsLayout><Deployment /></DocsLayout>} />
        <Route path="/docs/troubleshooting" element={<DocsLayout><Troubleshooting /></DocsLayout>} />
      </Routes>
    </MDXProvider>
  );
}
